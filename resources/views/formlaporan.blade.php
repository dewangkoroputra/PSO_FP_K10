    ...
    <div class="min-h-screen max-w-xl px-8 pt-8 mx-auto bg-slate-100">
        <form method="POST" enctype="multipart/form-data" action="/kehilangan">
            <section id="dataKendaraan">
                ...
                <div class="mb-4 pt-6">
                    <label for="default-input"
                        ...
                        Pelapor</label>
                    <input placeholder="Masukkan nomor handphone" required type="text" id="default-input"
                        name="kontak"
                ...
                <div class="mb-4">
                    <label for="countries"
                        ...
                        Kendaraan</label>
                    <select placeholder="Pilih jenis kendaraan" required id="countries" name="jenisKendaraan"
                ...
                <div class="mb-4">
                    <label for="default-input"
                        ...
                        Kendaraan</label>
                    <input placeholder="Masukkan model kendaraan" required type="text" id="default-input"
                ...
                <div class="mb-4">
                    <label for="default-input"
                        ...
                        Keluaran</label>
                    <input placeholder="Masukkan tahun keluaran" required type="text" id="default-input"
                        name="tahun_keluaran"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                ...
                <div class="mb-4">
                    <label for="default-input"
                        ...
                        Kendaraan</label>
                    <input placeholder="Masukkan warna kendaraan" required type="text" id="default-input"
                        name="warna"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                ...
                <div class="mb-8">
                    <label for="default-input"
                        ...
                        Kendaraan</label>
                    <input placeholder="Masukkan plat nomor kendaraan" required type="text" id="default-input"
                        name="plat_nomor"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>

                <!--Next Page Button-->
                <div id="btn-dataKendaraan"
                    class="mb-6 items-center justify-center w-full h-11 bg-blue-600 hover:bg-blue-700 rounded-lg">
                    <p
                        class="text-sm font-poppins font-medium leading-tight py-4 text-center justify-center text-white">
                        Selanjutnya</p>
                </div>
            </section>
            ...
            <section id="lokasiwaktuKejadian">
                ...
                <div class="mb-4">
                    <label for="default-input"
                        class="block mb-2 pt-6 text-sm font-poppins font-medium text-gray-900 dark:text-white">Model
                        Kendaraan</label>
                    <div class="hidden">
                        <div class="days">
                            <div
            ...
            <section id="deskripsiPendukung">
                ...
                <div class="inline-flex space-x-3.5 items-center justify-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <p class="flex-1 text-xs leading-none text-blue-800">Deskripsi dapat berupa hal spesifik yang ada
