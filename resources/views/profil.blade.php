    ...
    <body class="max-w-xl px-8 pt-8 mx-auto bg-slate-100 h-max">
        ...
        <div class="flex max-w-xl px-8 pb-6 items-center justify-center">
            <div class="w-80 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="w-full h-44 object-cover object-center rounded-t-lg" src="/assets/images.jpeg"
                        alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-poppins font-bold tracking-tight text-gray-900 dark:text-white">W 1234
                            PL</h5>
                    </a>
                    <div class="inline-flex flex-col space-y-2 items-start justify-start w-48 pt-2 pb-6">
                        <div class="flex flex-col space-y-0.5 items-start justify-start pb-2">
                            ...
                            <p class="text-xs font-poppins font-medium leading-none text-gray-600">Honda Beat 115 | Warna
                                Hitam | 2019</p>
                        </div>
                        <div class="flex flex-col space-y-0.5 items-start justify-start pb-2">
                            <div class="inline-flex space-x-1.5 items-center justify-start text-gray-400">
                            ...
                            <p class="text-xs font-poppins font-medium leading-none text-gray-600">Senin, 29 November 2022 |
                                03:15 WIB</p>
                        </div>
                        <div class="flex flex-col space-y-0.5 items-start justify-start">
                            ...
                            <p class="text-xs font-poppins font-medium leading-none text-gray-600">Jl. Sepanjang Jalan
                                Kenangan 123</p>
                        </div>
                    </div>
