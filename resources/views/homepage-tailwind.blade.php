    ...
    <body class="min-h-screen max-w-xl mx-auto bg-slate-100">
        ...
        <div class="px-6 pb-16">
            <div
                ...
                <p class="flex text-sm font-poppins font-medium leading-normal text-blue-800">Selalu letakkan kendaraan anda
                    pada tempat parkir yang sesuai dan gunakan kunci ganda sebelum meninggalkan kendaraan.</p>
            </div>
        </div>
