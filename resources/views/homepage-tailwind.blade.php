...
<body class="min-h-screen max-w-xl mx-auto bg-slate-100">
    ...
    <div class="px-6 pb-16">
        <div class="inline-flex space-x-4 items-center justify-center px-6 py-3 bg-blue-50 border rounded-xl border-blue-300 text-blue-800">
    ...
    <div class="max-w-xl px-6">
        ...
        <p class="text-sm font-poppins leading-normal text-gray-400">Berikut kami hadirkan data kejadian kehilangan kendaraan sebagai upaya meningkatkan kewaspadaan anda!</p>
    </div>

    <!--Infografis-->
    <div class="flex justify-center items-center p-8">
        <div class="inline-flex flex-col space-y-6 items-center justify-center w-80 max-w-xl p-4 bg-white shadow rounded-lg">
            <div class="flex flex-col space-y-1.5 items-start justify-start w-full">
                <p class="text-xs font-poppins font-medium leading-none text-gray-400">Data Kejadian Kehilangan Kendaraan</p>
            ...
            <div class="inline-flex space-x-6 items-center justify-center w-full">
                <div class="inline-flex flex-col space-y-0.5 items-start justify-center flex-1 p-3 bg-gradient-to-tr from-blue-700 via-blue-600 to-blue-500 rounded-xl">
