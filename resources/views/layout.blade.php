...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full" id="navbar-hamburger">
                <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 p-4">
                    <li>
                        <a href="{{ url('/') }}" class="flex w-full justify-end py-4 pl-3 pr-4 font-poppins text-lg text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Beranda</a>
                    </li>
                    <li>
                        <a href="{{ url('/tentang') }}"
                    ...
                    <li>
                        <a href="#"
                        data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="flex w-full justify-end py-4 pl-3 pr-4 font-poppins text-lg text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Panggil
                            Petugas</a>
                    </li>
                    <li>
                        <a href="{{ url('/profil') }}"
                                ...
                                <div class="flex justify-end">
                                    <div class="max-w-2xl inline-flex w-80 items-center justify-end space-x-4 rounded-xl border border-gray-300 py-3 pr-3">
                                        <div class="inline-flex flex-col items-end justify-center space-y-0.5">
                                            <p class="text-md font-semibold leading-tight text-gray-700">{{ Auth::user()->name }}</p>
                                        ...
                                        <div class="flex items-center justify-center rounded-full bg-gray-300 p-3.0">
                                            <div class="relative overflow-hidden text-grey-700 bg-gray-100 rounded-full dark:bg-gray-300">
    ...
    <footer class="max-w-xl mx-auto bg-gray-700">
        <div class="container inline-flex flex-col items-center justify-center">
            ...
            <a href=# data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="font-poppins text-base font-medium leading-snug text-white mt-2 mb-2">Panggil Petugas</a>
