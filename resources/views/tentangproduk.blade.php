...
<body class="max-w-xl mx-auto bg-slate-100">
    <div class="px-6 pt-6 pb-12">
        ...
        <div class="flex flex-col space-y-4 items-start justify-center pb-9">
            ...
            <p class="w-full font-poppins font-regular text-sm text-justify leading-regular text-gray-500">RanmITS merupakan platform berbasis website yang dikembangkan untuk membantu masyarakat dan juga petugas keamanan untuk mencegah dan menangani fenomena pencurian kendaraan bermotor yang sedang kerap terjadi belakangan ini yang tentunya sangat meresahkan masyarakat.</p>
        </div>
        ...
        <p class="w-full font-poppins font-regular text-sm text-justify leading-regular text-gray-500">RanmITS dikembangkan sebagai final project mata kuliah Rancang Bangun Perangkat Lunak/Software Engineering prodi S1 Sistem Informasi ITS. RanmITS dikembangkan oleh tim yang terdiri dari Naufal Firjatulloh Fano-5026211011, Zada Alfarras Rasendriya-5026211088, Evanriza Safiq Ariadi-5026211139, Rafi Arian Yusuf-5026211177, dan Laode Shaldan Falih-5026201178.</p>
        </div>
    </div>
